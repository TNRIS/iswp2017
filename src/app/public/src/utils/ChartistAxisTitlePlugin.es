 ...
 * Modified from original version at https://github.com/alexstanbury/chartist-plugin-axistitle
 */
/* eslint-disable */
...
function ctAxisTitlePlugin(options) {
...
module.exports = ctAxisTitlePlugin;
/* eslint-enable */